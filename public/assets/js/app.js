(function ($) {
  ...
  $(function () {
    for (
      ...
      // li
      if (!o.is("li")) break;
      o = o.parent().addClass("show").parent().addClass("open").addClass("dropdown-open");
    }
    
    // Show submenu for active dropdown on page load
    $(".sidebar-menu .dropdown.open .sidebar-submenu").show();
  });
