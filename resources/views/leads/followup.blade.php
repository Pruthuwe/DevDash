            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($latestFollowup)
                                <span class="text-sm">{{ $latestFollowup->followup_at->format('Y-m-d H:i') }}</span>
                            @else
                        ...
                        <div class="table-responsive mb-4">
                            <table class="table table-sm">
                                ...
                                <tbody id="fuHistoryRows">
                                    <tr><td colspan="5" class="text-center text-secondary-light">Loading...</td></tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="status" class="form-select" required>
                                        ...
                                        @foreach(['Interested','Need More Info','Follow Up Later','Not Interested','Converted','Closed'] as $s)
    ...
    btn.addEventListener('click', function () {
        ...
        fetch(`/leads/${id}/follow-up-detail`)
            ...
            .then(res => {
                ...
                if (!followups.length) {
                    document.getElementById('fuHistoryRows').innerHTML =
                        '<tr><td colspan="5" class="text-center text-secondary-light">No follow-up history found.</td></tr>';
                } else {
