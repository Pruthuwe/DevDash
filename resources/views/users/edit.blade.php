...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <div>
        <h6 class="fw-semibold mb-2">Edit User</h6>
    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0 text-lg">Edit User</h6>
                <p class="text-secondary-light mb-0 mt-2">Update user information</p>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="mb-24">
                        ...
                        <input type="text" class="form-control radius-8" id="name" name="name" placeholder="Enter full name" value="{{ old('name', $user->name) }}" required>
                        @error('name')
                    ...
                    <div class="mb-24">
                        ...
                        <input type="email" class="form-control radius-8" id="email" name="email" placeholder="Enter email address" value="{{ old('email', $user->email) }}" required>
                        @error('email')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-24">
                        <label for="password" class="form-label fw-semibold text-primary-light text-sm mb-8">
                            New Password <small class="text-secondary-light">(leave blank to keep current password)</small>
                        </label>
